...
**Key question:** *Which model best captures temporal patterns in electricity usage — and can we classify consumption levels with traditional ML?*
...
> *(Update this section after running all notebooks — paste final RMSE/MAE/R² from each model here for easy comparison)*
...
**Nguyen Trong**  
IT Student @ HCMUNS | Aspiring Data Analyst  
🔗 [LinkedIn](https://linkedin.com/in/nguyentrong243) · [GitHub](https://github.com/nguyentrong243)
